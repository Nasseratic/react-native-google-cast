...
export const MATCH_SWIFT_INIT = /public\s+override\s+func\s+application\s*\(\s*_?\s*application\s*:\s*UIApplication\s*,\s*didFinishLaunchingWithOptions\s+launchOptions\s*:.*\)\s*->\s*Bool/g;
